...
if __name__ == '__main__':
    ...
    parser.add_argument('--keep_extra', required=False, action='store_true', default=False, help="Retain extra files generated by simulatesearch")

    args = parser.parse_args()

    sig_params = {"flux": args.flux, "width": args.pulse_width}
    noise_params = {"tobs": args.tobs}
    psr_params = {"freq": args.freq, "fdot": args.fdot, "orbitP": args.orbitP/86400, "asini": args.asini, "ecc": args.ecc, "tasc": 54501.467101261028311}
    ...
    if not args.keep_extra:
        print("Cleaning extra files out...")
        clean_data(args.out_prefix, leave_ts=True)
