...
T0_OFFSETS=(1400 1410 1420 1430 1440 1450 1460 1470 1480 1490 1500 1510 1520 1530 1540 1560)
...
OUTDIR="/fred/oz022/vdimarco/software/install/viterbi_psr_search/code/experiments/47_Tuc_O_Alessandro_Ridolfi/47Tuc_blind_search_v1/inspection/cand_153_433hz/followup_v1/folds/T0_lower"
mkdir -p ${OUTDIR}
cd ${OUTDIR}
