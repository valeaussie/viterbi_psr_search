#!/bin/bash
#
#SBATCH --job-name=scalloping_long_pb
#SBATCH --output=logs/scalloping_long_pb%A_%a.txt
#SBATCH --ntasks=1
...
cp scalloping_results.dat /fred/oz002/ldunn/viterbi_psr_search/paper/scalloping/out_long_pb/scalloping_results_${SLURM_JOB_ID}_${SLURM_ARRAY_TASK_ID}.dat
